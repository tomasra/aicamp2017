    ...
    for index in range(len(documents)):
        ...
        if not error:
            ...
            if output:
                ...
                for i in range(-1, -10, -1):
                    printfunc(i, r, rank)
                    out_to_file.append(np.mean(rank))
    
    print(out_to_file)
    # f = open('/Users/tp/dev/ml/articles/Python-LSA/output.txt', 'w')
    # f.write(out_to_file)
    # f.close()
...
def is_stop_word(word):
    # stopwords = {'abi', 'abidvi', 'abiejose', 'abiejuose', 'abiejų', 'abiem', 'abigaliai', 'abipus', 'abu', 'abudu', 'ai', 'ana', 'anaiptol', 'anaisiais', 'anajai', 'anajam', 'anajame', 'anapus', 'anas', 'anasai', 'anasis', 'anei', 'aniedvi', 'anieji', 'aniesiems', 'anoji', 'anojo', 'anojoje', 'anokia', 'anoks', 'anosiomis', 'anosioms', 'anosios', 'anosiose', 'anot', 'ant', 'antai', 'anuodu', 'anuoju', 'anuosiuose', 'anuosius', 'anąja', 'anąją', 'anąjį', 'anąsias', 'anųjų', 'apie', 'aplink', 'ar', 'arba', 'argi', 'arti', 'aukščiau', 'aš', 'be', 'bei', 'beje', 'bemaž', 'bent', 'bet', 'betgi', 'beveik', 'dar', 'dargi', 'daugmaž', 'deja', 'dėka', 'dėl', 'dėlei', 'dėlto', 'ech', 'et', 'gal', 'galbūt', 'galgi', 'gan', 'gana', 'gi', 'greta', 'idant', 'iki', 'ir', 'irgi', 'it', 'itin', 'iš', 'išilgai', 'išvis', 'jaisiais', 'jajai', 'jajam', 'jajame', 'jei', 'jeigu', 'ji', 'jiedu', 'jiedvi', 'jieji', 'jiesiems', 'jinai', 'jis', 'jisai', 'jog', 'joji', 'jojo', 'jojoje', 'jokia', 'joks', 'josiomis', 'josioms', 'josios', 'josiose', 'judu', 'judvi', 'juk', 'jumis', 'jums', 'jumyse', 'juodu', 'juoju', 'juosiuose', 'juosius', 'jus', 'jąja', 'jąją', 'jąsias', 'jįjį', 'jųjų', 'jūs', 'jūsiškis', 'jūsiškė', 'jūsų', 'kad', 'kada', 'kadangi', 'kai', 'kaip', 'kaipgi', 'kas', 'katra', 'katras', 'katriedvi', 'katruodu', 'kažin', 'kažkas', 'kažkatra', 'kažkatras', 'kažkokia', 'kažkoks', 'kažkuri', 'kažkuris', 'kiaurai', 'kiek', 'kiekvienas', 'kieno', 'kita', 'kitas', 'kitokia', 'kitoks', 'kodėl', 'kokia', 'koks', 'kol', 'kolei', 'kone', 'kuomet', 'kur', 'kurgi', 'kuri', 'kuriedvi', 'kuris', 'kuriuodu', 'lai', 'lig', 'ligi', 'link', 'lyg', 'man', 'manaisiais', 'manajai', 'manajam', 'manajame', 'manas', 'manasai', 'manasis', 'mane', 'manieji', 'maniesiems', 'manim', 'manimi', 'maniškis', 'maniškė', 'mano', 'manoji', 'manojo', 'manojoje', 'manosiomis', 'manosioms', 'manosios', 'manosiose', 'manuoju', 'manuosiuose', 'manuosius', 'manyje', 'manąja', 'manąją', 'manąjį', 'manąsias', 'manęs', 'manųjų', 'mat', 'maždaug', 'mažne', 'mes', 'mudu', 'mudvi', 'mumis', 'mums', 'mumyse', 'mus', 'mūsiškis', 'mūsiškė', 'mūsų', 'na', 'nagi', 'ne', 'nebe', 'nebent', 'negi', 'negu', 'nei', 'nejau', 'nejaugi', 'nekaip', 'nelyginant', 'nes', 'net', 'netgi', 'netoli', 'neva', 'nors', 'nuo', 'nė', 'o', 'ogi', 'oi', 'paeiliui', 'pagal', 'pakeliui', 'palaipsniui', 'palei', 'pas', 'pasak', 'paskos', 'paskui', 'paskum', 'pat', 'pati', 'patiems', 'paties', 'pats', 'patys', 'patį', 'pačiais', 'pačiam', 'pačiame', 'pačiu', 'pačiuose', 'pačius', 'pačių', 'per', 'pernelyg', 'pirm', 'pirma', 'pirmiau', 'po', 'prie', 'prieš', 'priešais', 'pro', 'pusiau', 'rasi', 'rodos', 'sau', 'savaisiais', 'savajai', 'savajam', 'savajame', 'savas', 'savasai', 'savasis', 'save', 'savieji', 'saviesiems', 'savimi', 'saviškis', 'saviškė', 'savo', 'savoji', 'savojo', 'savojoje', 'savosiomis', 'savosioms', 'savosios', 'savosiose', 'savuoju', 'savuosiuose', 'savuosius', 'savyje', 'savąja', 'savąją', 'savąjį', 'savąsias', 'savęs', 'savųjų', 'skersai', 'skradžiai', 'stačiai', 'su', 'sulig', 'ta', 'tad', 'tai', 'taigi', 'taip', 'taipogi', 'taisiais', 'tajai', 'tajam', 'tajame', 'tamsta', 'tarp', 'tarsi', 'tartum', 'tarytum', 'tas', 'tasai', 'tau', 'tavaisiais', 'tavajai', 'tavajam', 'tavajame', 'tavas', 'tavasai', 'tavasis', 'tave', 'tavieji', 'taviesiems', 'tavimi', 'taviškis', 'taviškė', 'tavo', 'tavoji', 'tavojo', 'tavojoje', 'tavosiomis', 'tavosioms', 'tavosios', 'tavosiose', 'tavuoju', 'tavuosiuose', 'tavuosius', 'tavyje', 'tavąja', 'tavąją', 'tavąjį', 'tavąsias', 'tavęs', 'tavųjų', 'tačiau', 'te', 'tegu', 'tegul', 'tiedvi', 'tieji', 'ties', 'tiesiems', 'tiesiog', 'tik', 'tikriausiai', 'tiktai', 'toji', 'tojo', 'tojoje', 'tokia', 'toks', 'tol', 'tolei', 'toliau', 'tosiomis', 'tosioms', 'tosios', 'tosiose', 'tu', 'tuodu', 'tuoju', 'tuosiuose', 'tuosius', 'turbūt', 'tąja', 'tąją', 'tąjį', 'tąsias', 'tųjų', 'tūlas', 'už', 'užtat', 'užvis', 'va', 'vai', 'viduj', 'vidury', 'vien', 'vienas', 'vienokia', 'vienoks', 'vietoj', 'virš', 'viršuj', 'viršum', 'vis', 'vis dėlto', 'visa', 'visas', 'visgi', 'visokia', 'visoks', 'vos', 'vėl', 'vėlgi', 'ypač', 'į', 'įkypai', 'įstrižai', 'šalia', 'še', 'ši', 'šiaisiais', 'šiajai', 'šiajam', 'šiajame', 'šiapus', 'šiedvi', 'šieji', 'šiesiems', 'šioji', 'šiojo', 'šiojoje', 'šiokia', 'šioks', 'šiosiomis', 'šiosioms', 'šiosios', 'šiosiose', 'šis', 'šisai', 'šit', 'šita', 'šitas', 'šitiedvi', 'šitokia', 'šitoks', 'šituodu', 'šiuodu', 'šiuoju', 'šiuosiuose', 'šiuosius', 'šiąja', 'šiąją', 'šiąsias', 'šiųjų', 'štai', 'šįjį', 'žemiau'};
    stopwords = []
    with open('/Users/tp/dev/ml/articles/Python-LSA/words_sorted_by_freq.txt') as file:
        stopwords = file.read()

    stopwords = stopwords.split(',')[0:100]

    with open('/Users/tp/dev/ml/articles/Python-LSA/dalelyte.txt') as file:
        f = file.read().split(',')
        stopwords.append(f)

    with open('/Users/tp/dev/ml/articles/Python-LSA/jungtukai.txt') as file:
        f = file.read().split(',')
        stopwords.append(f)
